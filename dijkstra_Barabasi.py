...
barabasi_.savedArchivoDijsktra('{}_n{}'.format('_completo',str(nodo)))

n_inicia = list(barabasi_.nodos.keys())[0]
n_final = list(barabasi_.nodos.keys())[nodo_fin]

grafoDijkstra = Grafo.dijkstra(barabasi_,n_inicia,n_final)
grafoDijkstra.savedArchivoDijsktra('{}_n{}'.format('_Barabasi',str(nodo)))
